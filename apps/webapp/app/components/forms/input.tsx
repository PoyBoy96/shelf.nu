...
const Input = forwardRef(function Input(
  ...
  const inputClasses = tw(
    "w-full max-w-full border border-gray-300 bg-white px-[14px] py-2 text-[16px] text-gray-900 shadow outline-none placeholder:text-gray-500 focus:border-primary-300 focus:ring-[0] disabled:cursor-not-allowed disabled:border-gray-300 disabled:bg-gray-50 disabled:text-gray-500 disabled:placeholder:text-gray-300",
