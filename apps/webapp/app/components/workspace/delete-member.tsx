      ...
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button
            ...
            className="justify-start rounded-sm  p-3 text-sm font-semibold text-gray-700 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-gray-100 hover:text-gray-700"
            width="full"
          >
