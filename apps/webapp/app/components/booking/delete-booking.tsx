    ...
    <AlertDialog>
      <AlertDialogTrigger asChild>
        <Button
          ...
          className="justify-start rounded-sm px-2 py-1.5 text-sm font-medium text-gray-700 outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 hover:bg-gray-100 hover:text-gray-700"
          width="full"
        >
          Delete
        </Button>
